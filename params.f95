...
implicit none
  ...
  double precision, parameter :: beta = 0.975 ! hh discount factor => r = 2,67% 
  double precision, parameter :: eta = 0.5 ! hh IES
  ...
  integer, parameter :: vecsize = 30 ! colsize of lgrid and bgrid
